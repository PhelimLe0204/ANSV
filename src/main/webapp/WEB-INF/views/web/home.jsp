					...
					<c:forEach var="item_highlight" items="${highlight}"
						...
						<div class="col-lg-4">
							<div class="post-module">
								<div class="thumbnail">
									<img
										src="<c:url value="/assets/user/img/noi_bat/${item_highlight.img}" />">
								</div>
													...
													<div class="post-module">
														...
														<div class="post-content">
															<div class="post-content-child-news">
																...
																<div class="post-meta" align="right">
																	<span class="comments"> <a
																		href="<c:url value='/detail_${item_news.id}' />">Xem
																			thêm...</a>
																	</span>
																</div>
															</div>
				...
				<div class="row content">
					<div class="col-lg-6 " style="padding-top: 10px;"
						...
						<p style="text-align: justify;">
							Với 30 năm kinh nghiệm, công ty TNHH Thiết Bị Viễn Thông <font
								...
								<div class="tab-pane container p-0 fade" id="home3">
									<p style="text-align: justify;">
										<span> "Văn hóa là tinh thần - Sức mạnh Team work" luôn
											...
											pháp, dịch vụ công nghệ chất lượng cao, hữu ích phục vụ cuộc
											sống và cộng đồng.
										</span>
									</p>
								</div>
