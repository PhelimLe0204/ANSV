...
<head>
<meta charset="UTF-8">
<title>Chuyên ngành viễn thông</title>
</head>
<body>
	...
	<section class="telecom">
		<div class="container">
				...
				<div class="row ">
					...
					<div class="col-md-6" data-aos="fade-left">
						<img alt="" class="img-fluid"
							src="<c:url value="/assets/user/img/5g.jpg" />">
					</div>
				</div>
			</div>
			<div class="section-2  mt-5" data-aos="fade-up">
				<h3>
					<b>2.Giải pháp hệ thống mạng GPON</b>
				</h3>
				<div class="row mt-5 ">
					<div class="col-md-6" data-aos="fade-left">
						<img alt="" class="img-fluid"
			...
			<div class="section-3 mb-5 bg-dak mt-5" data-aos="fade-up">
				<h3>
					<b>3.Công nghệ Truyền dẫn</b>
				</h3>
				<div class="row ">
					<div class="col-md-6 mt-4 pt-4" data-aos="fade-right">
						<div class="">
							<p class="justify">• ANSV tự hào là đơn vị triển khai các dự
								...
								Mobifone.</p>
							<p class="justify">• Trong 30 năm qua, ANSV với tiền thân là
								công ty liên doanh Thiết bị Viễn thông - Alcatel Network Systems
								Vietnam là đối tác chính thức của Nokia (trước đây là
			...
			<%-- <div class="section-4 " data-aos="fade-up">
				...
				<div class="row mt-5 ">
					...
					<div class="col-md-6 mt-5 pt-4" data-aos="fade-right">
						<div class="">
							<p>• Mạng viễn thông thế hệ mới – NGN (Next Generation
								Network) đã trở thành xu hướng của nhiều nước trên thế giới do
								những lợi ích của nó cả về kinh tế và kỹ thuật trong việc cung
								cấp các dịch vụ đa phương tiện. Cùng trên xu hướng phát triển đó
								các mạng viễn thông tại Việt nam đang từng bước được xây dựng
								theo định hướng tiến tới mạng hội tụ NGN.</p>
						</div>
					</div>
				</div>
			</div> --%>
