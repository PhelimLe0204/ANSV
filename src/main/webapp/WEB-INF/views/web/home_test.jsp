	...
	font-weight: bold !important;
				...
				<div class="row content">
						...
						<div class="post-module">
							...
							<div class="post-content">
								<div class="post-content-child">
									...
									<p class="description">Công ty TNHH Thiết bị Viễn thông
										ANSV được thành lập từ tháng 7 năm 1993 trong quan hệ hợp tác
										liên doanh giữa Tập đoàn Alcatel (nay là Alcatel-Lucent)
										với...</p>
					...
					<div class="col-lg-4">
						<div class="post-module">
							<div class="thumbnail">
								<img src="<c:url value="/assets/user/img/5g_1.jpg" />">
							</div>
							<div class="post-content">
								<div class="post-content-child">
									...
									<p class="description">
										...
										<font color="#e67e22"><b>ANSV</b></font> là đơn vị đầu tiên
										thực hiện các dự án triển khai mạng di động từ những năm 1993
										tới nay, Cùng với cách mạng công nghiệp 4.0 và sự bùng nổ công
										nghệ thông tin...
									</p>
									<div class="post-meta" align="right">
							...
							<div class="post-content">
								<div class="post-content-child">
									...
									<p class="description">
										...
										Trung tâm thông tin, chỉ đạo điều hành bao gồm: các dữ liệu số
										về tình hình biến động các chỉ số kinh tế - xã hội của địa
										phương, tỉnh, thành phố, quốc gia; các chỉ số...
									</p>
									<div class="post-meta" align="right">
										<span class="comments"> <a href="cong-nghe-thong-tin">Xem
												thêm...</a>
										</span>
									</div>
								</div>
												...
												<div class="post-module">
													...
													<div class="post-content">
														<div class="post-content-child-news">
															<a href="#"><font color="gray">TIN TỨC</font></a> <br>
															<br>
															<h1 class="title"></h1>
															<h2 class="sub_title desc title-bold">
																<font color="#ef6c00"> VNPT và Nokia hợp tác về
																	nghiên cứu và phát triển hạ tầng số </font>
															</h2>
												...
												<div class="post-module">
													...
													<div class="post-content">
														<div class="post-content-child-news">
															...
															<h1 class="title"></h1>
															<h2 class="sub_title desc title-bold">
																<font color="#ef6c00"> Thống nhất mã QR dùng
																	chung cho các nền tảng công nghệ chống dịch </font>
															</h2>
															<p class="description">Mỗi cá nhân sử dụng các nền
																tảng, ứng dụng phòng chống dịch Covid-19 được cấp duy
																nhất một mã QR cá nhân. Mã QR cá nhân có thể được sử
																dụng để cá nhân, tổ chức có thẩm quyền đọc và truy vấn
																các dữ liệu liên quan phục vụ công tác phòng, chống
												...
												<div class="post-module">
													...
													<div class="post-content">
														<div class="post-content-child-news">
															...
															<h1 class="title"></h1>
															<h2 class="sub_title desc title-bold">
																<font color="#ef6c00"> Tốc độ Internet Việt Nam
																	thấp hơn mức trung bình thế giới </font>
															</h2>
															<p class="description">
																...
																tại Việt Nam có thể sẽ không cải thiện do tuyến cáp
																AAE-1 gặp lỗi và tiếp tục bị ảnh hưởng từ sự cố với
																tuyến cáp AAG xảy ra hồi tháng 7.
															</p>
															<div class="post-meta" align="right">
																<span class="comments"> <a
																	href="javascript:void(0)">Xem thêm...</a>
												...
												<div class="post-module">
													...
													<div class="post-content">
														<div class="post-content-child-news">
															...
															<h1 class="title"></h1>
															<h2 class="sub_title desc title-bold">
																<font color="#ef6c00"> Đẩy nhanh việc triển khai
																	và thương mại hóa 5G tại Việt Nam </font>
															</h2>
			...
			<div class="container" data-aos="fade-up">
				...
				<div class="row content">
					<div class="col-lg-6 " style="padding-top: 10px;"
						...
						<!-- <h3>Với 30 năm kinh nghiệm, công ty TNHH Thiết Bị Viễn Thông ANSV là nhà tích hợp hệ thống, cung cấp các sản phẩm/giải pháp và dịch vụ công nghệ thông tin hàng đầu tại Việt Nam, có vị thế vững chắc ở thị trường trong nước và trong khu vực</h3>-->
						<p style="text-align: justify;">Với 30 năm kinh nghiệm, công
							ty TNHH Thiết Bị Viễn Thông ANSV là nhà tích hợp hệ thống, cung
							cấp các sản phẩm/giải pháp và dịch vụ công nghệ thông tin hàng
